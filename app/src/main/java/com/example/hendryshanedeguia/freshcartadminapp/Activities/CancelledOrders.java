...
public class CancelledOrders extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lv = (ListView) findViewById(R.id.lvCancelledOrders);
        orderList =new ArrayList<>();
        ordersDBF = FirebaseDatabase.getInstance().getReference("Orders").child("All Orders");
        adapter = new NewOrdersAdapter(CancelledOrders.this, R.layout.new_orders_layout, orderList);
        ...
        ordersDBF.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    ...
                    if(TextUtils.equals(snapshot.child("orderStatus").getValue().toString(),"Cancelled")){
