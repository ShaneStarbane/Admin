...
public class CancelledOrdersAdapter extends ArrayAdapter {

    private Activity context;
    private int resource;
    private List<OrderMainDetailsModel> listOrders;
    public CancelledOrdersAdapter(@NonNull Activity context, @LayoutRes int resource, @NonNull List objects) {
